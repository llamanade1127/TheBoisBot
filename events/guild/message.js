...
module.exports = ( Discord, client, message) => {
    ...
    if(!message.content.startsWith(prefix)) return eval(message);
...
function eval(message){
    ...
    if(message.content.toLowerCase().includes('nigger')){
        data.addNWord(message.guild.id, message.author.id, true);
        //message.delete();
        //message.channel.send(`Bro your not funny ${message.author}`);
    }
    if(message.content.toLowerCase().includes('nigga')){
        data.addNWord(message.guild.id, message.author.id, false);
        //message.delete();
        //message.channel.send(`Bro your not funny ${message.author}`);
    }
}